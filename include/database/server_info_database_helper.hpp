...
public:
    ...
    int record_num();
    int insert_record(std::string server_id, std::string client_pubkey, std::string client_add_time, std::string mode, std::string water_amount, std::string scheduled_freq, std::string scheduled_time);
